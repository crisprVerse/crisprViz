...
FEATURES: annotations, includeSNPTrack, guideStacking, multiple guidesets...

[begin with one (fully set up), then lead into plotting another for comparison]
